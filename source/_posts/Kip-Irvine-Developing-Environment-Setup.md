...
基于Assembly 的复杂性和死板性，配置Assembly的编程环境也充满了困难。这篇文章针对《Assembly Language For x86 Processors, 7th Edition》（by Kip Irvine）做出一系列配置环境教程，简化大家的配置方法。
...
<div class="video-container"><iframe allowfullscreen="" frameborder="0" src="//www.youtube.com/embed/9e1ER2o83N0"></iframe></div>

## 相关资料

对于Kip Irvine 的资料不可以自己编译，所有的环境文件都需要在网站上下载下来这里是网址：
